...
export async function handleGetTicket(client: ZendeskClient, input: unknown) {
...
export async function handleListTickets(client: ZendeskClient, input: unknown) {
  const { status, per_page } = listTicketsInputSchema.parse(input ?? {});
  return client.listTickets(status as TicketStatus | undefined, per_page);
}

export async function handleCreateTicket(client: ZendeskClient, input: unknown) {
...
export async function handleUpdateTicket(client: ZendeskClient, input: unknown) {
...
export async function handleAddComment(client: ZendeskClient, input: unknown) {
...
export async function handleListTicketComments(client: ZendeskClient, input: unknown) {
